...
func (wx *Wechat) AddShakeDevice(quantity int, applyReason, comment string, poiid int) (res ResShakeDevice) {
	...
	d, _ := json.Marshal(t)
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/device/applyid", param),
		bytes.NewReader(d))
...
func (wx *Wechat) ChkeckShakeDevice(applyid int) (res ResShakeDevice) {
	...
	t := stTmp{applyid}
	d, _ := json.Marshal(t)
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/device/applystatus", param),
		bytes.NewReader(d))
	resBody, err := common.RequsetJSON(req, 0)
	if err != nil {
		log.Println(err)
...
func (wx *Wechat) AddShakePage(title, description, pageurl, comment, iconurl string) int {
	...
	d, _ := json.Marshal(t)
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/page/add", param),
		bytes.NewReader(d))
	resBody, err := common.RequsetJSON(req, 0)
	if err != nil {
		log.Println(err)
...
func (wx *Wechat) UpdateShakePage(pageid int, title, description, pageurl, comment, iconurl string) int {
	...
	d, _ := json.Marshal(t)
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/page/update", param),
		bytes.NewReader(d))
	resBody, err := common.RequsetJSON(req, 0)
	if err != nil {
		log.Println(err)
...
func (wx *Wechat) SearchShakePage(typeid int, pageids []int, begin, count int) []STShakePage {
	...
	d, _ := json.Marshal(t)
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/page/search", param),
		bytes.NewReader(d))
	resBody, err := common.RequsetJSON(req, 0)
	if err != nil {
		log.Println(err)
...
func (wx *Wechat) DeleteShakePage(pageid int) int {
	...
	d, _ := json.Marshal(t)
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/page/delete", param),
		bytes.NewReader(d))
...
func (wx *Wechat) UploadShakeImage(mediaType, filepath string) string {
	...
	req, err := newfileUploadRequest(common.Param("https://api.weixin.qq.com/shakearound/material/add", param), nil,
		"media", filepath)
	if err != nil {
		return ""
	}
...
func (wx *Wechat) SetLotterySwitch(lotteryid string, onoff int) int {
	...
	req, err := http.NewRequest("POST", common.Param("https://api.weixin.qq.com/shakearound/lottery/setlotteryswitch", param),
		nil)
	if err != nil {
		log.Println(err)
		return 0
